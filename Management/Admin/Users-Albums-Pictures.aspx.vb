...
Partial Class Management_Admin_Users_Albums_Pictures
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Title = String.Format("مدیریت شهر دات کام - مدیریت عکسهای کاربر {0}", ClassProfile_Section.GetFnLn(Request.QueryString("email")))
    End Sub
    ...
    Public Function GetCountPhoto(ByVal Code As Object) As String
        Return ClassPost.GetCountPhotoAlbum(Val(Code))
    End Function
    ...
    Public Sub DeletePhoto(ByVal sender As Object, ByVal e As CommandEventArgs)
        ClassPost.DeletePhoto(e.CommandArgument)
        DG_PhotoNotAlbum.DataBind()
    End Sub
