<%@ Page Language="VB" MasterPageFile="~/user/User.master" AutoEventWireup="false"
    CodeFile="AllPolling.aspx.vb" Inherits="user_AllPolling" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="Div_InfoPersonal" runat="server" style="color: Gray; float: right; width: 540px;
        ...
        <div class="DivTop">
            <asp:Label ID="lblTitleInformation" runat="server" Text="" Style="color: gray; font-family: Tahoma;
                ...
                <tr>
                    <td>
                                        ...
                                        <td class="style6">
                                            <div style="background-color: #f1f6f8; -moz-border-radius: 3px; border: 1px solid #D7E2E8;
                                                ...
                                                <div style="float: right; width: 505px; height: 20px;">
                                                    <h1 style="font-weight: normal; font-size: 11px; color: Black;">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <div style="border: solid #ccc 1px; -moz-border-radius: 5px; width: 530px;">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:DataList ID="Dl_user" runat="server" DataSourceID="ODS_UserParticipate" RepeatColumns="15"
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton runat="server" ForeColor="Transparent" OnCommand="RedirectFriend"
                                                        CommandArgument='<%# Eval("email","{0}") %>' ID="ImageButton3" runat="server"
                                                        BorderColor="#CCCCCC" BorderWidth="1px" Height="25px" ImageUrl='<%# "~/user/Crop.aspx?P="+Eval("picpath", "{0}")+"&W=30&H=30" %>'
                                                        Width="25px" />
                                                </ItemTemplate>
                                            </asp:DataList>
                        ...
                        <asp:ObjectDataSource ID="ODS_Polling" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
                            OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DS_View_Users_SectionsTableAdapters.Profile_AllPollingTableAdapter"
                            UpdateMethod="Update">
                            <DeleteParameters>
