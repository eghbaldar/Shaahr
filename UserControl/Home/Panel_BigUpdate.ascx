<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Panel_BigUpdate.ascx.vb"
    Inherits="UserControl_Home_Panel_BigUpdate" %>
<!-- Tabs -->
<style type="text/css">
    .PageS, PageS td
    {
...
<script type="text/javascript">
        function VisiblePutComment(e)
        {
             var str=e.split('_');
             document.getElementById('DivComment_'+str[1]).style.display='inline';
        }
</script>
...
<script type="text/javascript">
        ...
        {
            var str=e.split('_');
            document.getElementById('DivYesNo_'+str[1]).style.display='inline';
            document.getElementById('DivDelete_'+str[1]).style.display='none';
        }
        function invisible(e)
        {
            document.getElementById('DivDelete_'+e).style.display='inline';
            document.getElementById('DivYesNo_'+e).style.display='none';
        }
</script>
...
<div id="Content" runat="server">
    <div id="object" style="margin-top: 4px;">
        <div style="background-color: #EFF4F7; width: 526px; height: 15px; font-family: Tahoma;
            border: 1px solid #D6E1E7; font-size: 10px; color: #587C8C; padding: 2px; -moz-border-radius: 3px;
            -webkit-border-radius: 3px; border-radius: 3px;">
            بروزرسانی دوستان
        </div>
        <div style="width: 391px; height: 100%; background-color: #fff; padding: 3px;">
            <asp:GridView ID="Dl_UpdateNews" runat="server" AutoGenerateColumns="False" DataKeyNames="code"
                DataSourceID="ODS_ProfileUpdateNews" GridLines="None" ShowFooter="True" AllowPaging="True"
                PageSize="5">
                <PagerStyle CssClass="PageS" />
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <%--   Visible='<%# UserPermission(DataBinder.Eval(Container.DataItem,"for_who"))  %>'--%>
                            <asp:Panel ID="Panel2" Style="background-color: #f5f5f5; border: solid #ccc 1px;
                                -moz-border-radius: 5px; width: 523px; -webkit-border-radius: 5px;" runat="server">
                                <table class="style2">
                                    <tr>
                                        <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="float: left; margin-top: 0px; margin-right: 2px; height: 15px; padding-bottom: 30px;">
                                                            <div id='<%# "DivDelete_"+Eval("Code","{0}") %>' onclick="return ActionDelete(this.id);">
                                                                <span id="Span1" style="font-size: 24px; color: #A6A6A6; cursor: pointer;" runat="server"
                                                                    visible='<%# iif(session("MY-UsErNaMe")="" Or session("MY-UsErNaMe")<> Eval("email","{0}") ,false,true) %>'>
                                                                    × </span>
                                                            </div>
                                                            <div id='<%# "DivYesNo_"+Eval("Code","{0}") %>' style="width: 50px; padding-right: 6px;
                                                                padding-top: 3px; padding-bottom: 3px; display: none;">
                                                                <asp:ImageButton ID="ImageButton1" ForeColor="Transparent" AlternateText="" ImageUrl="~/Content/images/Home/OK_delete.png"
                                                                    CommandArgument='<%# Eval("code","{0}") %>' OnCommand="DeleteObject" runat="server" />
                                                                <img src="../Content/images/Home/NOK_delete.png" onclick="return invisible(this.id);"
                                                                    style="cursor: pointer;" id='<%# Eval("Code","{0}") %>' />
                                                            </div>
                                                            <asp:ImageButton ImageUrl="~/Content/images/Stage/Nazmie/hatDecetive.png" ToolTip="َگزارش به نظمیه"
                                    ...
                                    <tr>
                                        <td>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-family: Tahoma; font-size: 11px">
                                                                            <div style="border: solid #ccc 1px; -moz-border-radius: 5px; width: 505px;">
                                            ...
                                            <div id="Div1" style="text-align: center; background-color: #ECECEC; width: 518px;
                                                ...
                                                <div class="yoxview">
                                                    <a href='<%# "../Content/images/Profile/Photo/"+Eval("string_factor", "{0}") %>'>
                                                        <asp:Image ID="imgPic" runat="server" CommandArgument='<%# Eval("code", "{0}")+"|"+Eval("email", "{0}")+"|"+Eval("string_factor", "{0}") %>'
                                                            ImageUrl='<%# "~/user/CropPhoto.aspx?P="+Eval("string_factor", "{0}")+"&W=512&H=260" %>'
                                                            Visible='<%# IIF(Eval("type")=0,true,false) %>' />
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="UpdatePanel123" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div>
                                                        <asp:DataList ID="DL_Comment" runat="server" DataSourceID="ODS_Comments" Width="520px">
                                                            <ItemTemplate>
                                                                ...
                                                                <div style="background-color: #edeff4; border: 1px solid #E6E6E6; width: 478px; -moz-border-radius: 3px;
                                                    ...
                                                    <div>
                                                        <div id='<%# "DivPutComment_"+Eval("code","{0}") %>' style="background-color: #ccc;
                                                            margin-right: 48px; margin-top: -4px; width: 465px; padding: 2px;" onmousemove="return VisiblePutComment(this.id);">
                                                            <asp:TextBox Visible='<%# iif(Session("MY-UsErNaMe")="","false","true") %>' Style="margin-top: 1px;
                                                                border: 1px solid #a8a8a8; font-family: Tahoma; resize: none; padding: 1px; font-size: 11px;"
                                                                ID="txtPutComment" runat="server" Width="461px" Text="نظر شما..." ForeColor="#999999"
                                                                onfocus="if(this.value=='نظر شما...'){this.value='';}" TextMode="MultiLine" Height="20px"
                                                                onblur="if(this.value==''){this.value='نظر شما...';}if(this.value=='نظر شما...')this.style.color='#999999';"
                                                                onmousedown="this.style.color='#000000';" onkeydown="if(event.keyCode==13){return InsertComment(this.value);}" />
                                                            <div id='<%# "DivComment_"+Eval("code","{0}") %>' style="display: none;">
                                                                <asp:LinkButton Visible='<%# iif(Session("MY-UsErNaMe")="","false","true") %>' ID="btnSendPost"
                                                                    OnCommand="SendCommand" Style="color: #58808C; font-family: koodak; font-size: 13px;
                                                                    text-decoration: none; margin-right: 2px;" CommandArgument='<%# Eval("code","{0}") %>'
                                                        ...
                                                        <div style="height: 24px;">
                                                            ...
                                                            <div style="float: right; padding-top: 5px; font-family: Tahoma; font-size: 11px;
                                                                padding-right: 2px;">
                                                                <asp:UpdateProgress AssociatedUpdatePanelID="UpdatePanel123" ID="UpdateProgress2"
                                                                    runat="server">
                                                                    <ProgressTemplate>
                                                                        <img src="../content/images/Profile_View_Users/Loading_0.gif" /></ProgressTemplate>
                                                                </asp:UpdateProgress>
            ...
            <!-- -->
            <div class="AllPost">
                <asp:LinkButton ID="btnShowAllPost" runat="server" Style="text-decoration: none;
                    color: #577E8D;"> نمایش همه پست ها</asp:LinkButton>
            </div>
        </div>
    </div>
</div>
