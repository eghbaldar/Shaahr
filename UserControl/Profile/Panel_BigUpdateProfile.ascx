<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Panel_BigUpdateProfile.ascx.vb"
    Inherits="UserControl_Profile_Panel_BigUpdateProfile" %>
<!-- Tabs -->
<style type="text/css">
    .PageS, PageS td
    {
...
<div id="Content" runat="server">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div>
                                                <div id='<%# "DivPutComment_"+Eval("code","{0}") %>' style="background-color: #ccc;
                                                    margin-right: 48px; margin-top: -4px; width: 485px; padding: 2px;" onmousemove="return VisiblePutComment(this.id);">
                                                    <asp:TextBox Style="margin-top: 1px; border: 1px solid #a8a8a8; font-family: Tahoma;
                                                        ...
                                                        Visible='<%# iif(Session("MY-UsErNaMe")="","false","true") %>' Width="481px"
                                                        Text="نظر شما..." ForeColor="#999999" onfocus="if(this.value=='نظر شما...'){this.value='';}"
    ...
    <asp:ObjectDataSource ID="ODS_ProfileUpdateNews" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="DS_View_UsersTableAdapters.Profile_UpdateNewsAllTableAdapter">
        <SelectParameters>
            <asp:Parameter Name="email" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
