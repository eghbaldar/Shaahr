<%@ Page Language="VB" MasterPageFile="~/home/Menu/MyRoom/Home.master" AutoEventWireup="false"
    CodeFile="Familys.aspx.vb" Inherits="home_Menu_MyRoom_Familys" Title="Untitled Page" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="DG" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ShowHeader="False" AllowPaging="True" Width="739px" PageSize="30">
                                ...
                                <ItemTemplate>
                                    <div style="border-bottom: 1px solid #ccc; width: 732px;">
                                        <table style="width: 100%">
                                            <tr>
                                                <td class="style9">
                                                    <asp:ImageButton ID="ImageButton1" runat="server" ForeColor="Transparent" ImageUrl='<%# SetAvatar(DataBinder.Eval(Container.DataItem,"user")) %>'
                                                ...
                                                <td>
                                                    <div style="float: right;">
                                                        <div style="float: right; width: 700px;">
                                                            ...
                                                            <br />
                                                            <asp:Label ID="Label2" runat="server" Text='<%# GteType(DataBinder.Eval(Container.DataItem,"user")) %>'></asp:Label>
